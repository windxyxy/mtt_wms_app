...
//            AppStart.GetInstance().HandlerSendMessage(FinalManager.LoginActivityName, message);
//        }
//    }
//
//    /*消息接收器*/
...
//            }
//        };
//        ((AppStart)getApplication()).SetHandler(FinalManager.LoginActivityName,handler);
//    }
//
//
//    @Override
...
//        ((AppStart)getApplication()).DelHandler(FinalManager.LoginActivityName);
//        super.onDestroy();
//    }
//
//    public void LoginClickEvent(View view) {
//        Log.d("loginActivity", "onLoginClickEvent.............");
//        /*启动通讯服务*/
...
//
//
//    public void GetCGDClickEvent(View view) {
//        List<Hashtable<String, String>> listhas = new ArrayList<Hashtable<String, String>>();
//        TranCoreClass tranCoreClass = null;
//        tranCoreClass =   (TranCoreClass)  ((AppStart)getApplication()).GetCommunicationConn().SyncSend(203,"select * from t_purchase where indexid = 3");
//        if(tranCoreClass!=null) {
//            Log.d("loginActivity", "Get CGD Sucess.............");
//            listhas = ConnTranPares.GetData(tranCoreClass, listhas.getClass());
//        }
//        else
