...
public class UpdateAppManager {
    ...
    // 以华为天天聊hotalk.apk为例
    private String spec = "http://s1.music.126.net/download/android/CloudMusic_official_3.7.3_153912.apk";
    // 下载应用的对话框
     ...
     * 检测应用更新信息
     */
    public void checkUpdateInfo(String Download_address) {
        spec = Download_address;
        showNoticeDialog();
