 ...
 */
public class allocation_task extends buttom_state {

    private List<Hashtable> listData = new ArrayList<Hashtable>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.allocation_task);


        List<Hashtable> listhas = new ArrayList<Hashtable>();
        String SQL="select * from t_out_stock where orderStatus =3  and orderType='DBCK' union" +
                " select a.* from t_out_stock as a join t_out_stock_log as b on a.outStockNo= b.outStockNo  where a.orderStatus = 4 and  a.orderType='DBCK'  and b.userID ="+AppStart.GetInstance().getUserID()+"";


        listData = Datarequest.GetDataArrayList(SQL);
        if(listData.size()==0){
            AlertDialog.Builder build = new AlertDialog.Builder(allocation_task.this);
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   /*jhPosition*/
                    ...
                    intent.setClass(allocation_task.this, allocation_picking.class);
                    startActivity(intent);
                    allocation_task.this.finish();
                }
            });
    ...
    /*返回*/
    public void backhome_pages(View v){
        Intent myIntent = new Intent();
        myIntent = new Intent(allocation_task.this, outbound_menu.class);
